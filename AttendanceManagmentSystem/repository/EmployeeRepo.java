...
public class EmployeeRepo implements IEmployeeRepo{
	...
	public void insert(Employee e){
		String query = "INSERT INTO employees VALUES ('"+e.getEmpId()+"','"+e.getName()+"','"+e.getDesignation()+"');";
		try
		{
			dbc.openConnection();
	...
	public void update(Employee e){
		String query = "UPDATE employees SET employeeName='"+e.getName()+"', designation = '"+e.getDesignation()+"' WHERE empId='"+e.getEmpId()+"'";
		try
		{
			dbc.openConnection();
	...
	public Employee searchEmployee(String empId){
		Employee emp = null;
		String query = "SELECT `employeeName`, `designation` FROM `employees` WHERE `empId`='"+empId+"';";     
		try
		{
	...
	public String[][] getAllEmployee(){
		...
		try
		{
			...
			while(dbc.result.next())
			{
				...
				Employee e = new Employee(empId,name,designation);
				ar.add(e);
			}
		}
		catch(Exception e){System.out.println(e.getMessage());}
